...
class ChannelTimelineEntry(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, action, agent, request_body, status_code, timestamp, trace_id, *args, **kwargs):  # noqa: E501
        """ChannelTimelineEntry - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, action, agent, request_body, status_code, timestamp, trace_id, *args, **kwargs):  # noqa: E501
        """ChannelTimelineEntry - a model defined in OpenAPI
