...
class Slate(ModelNormal):
    ...
    def _from_openapi_data(cls, uri, *args, **kwargs):  # noqa: E501
        """Slate - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            duration (int): Slate duration (ms). [optional] if omitted the server will use the default value of 0  # noqa: E501
        """
