...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AuditOperationsApi()
        api_instance.get_channel_timeline  # this is an instance of the class Endpoint
        api_instance.get_channel_timeline()  # this invokes api_instance.get_channel_timeline.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_channel_timeline.callable or self.callable in this class
